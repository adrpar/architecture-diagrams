...
def generate(output: str, project: str, views: str | None, tags_: str | None, modules_: str | None, prune_to_views: bool) -> None:
    ...
    dsl = build_workspace_dsl(project=project, workspace_name=workspace_name, select_names=names, select_tags=tags, select_modules=modules, prune_to_views=prune_to_views)
