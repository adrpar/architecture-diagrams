...
@click.option("--exporter", default="structurizr", help="Exporter to use: structurizr (default) or json")
@click.option("--tagging", default=None, help="Comma-separated tagging strategies to apply (e.g., auto_external)")
@click.option("--view-generator", default=None, help="Name of a view generator plugin to run (e.g., delta_lineage)")
@click.option("--view-generator-config", default=None, help="JSON string with config for the view generator")
@click.option("--enable-cache/--no-cache", default=False, help="Enable output caching based on inputs")
@click.option("--verbose", is_flag=True, default=False, help="Enable verbose logging for troubleshooting")
def generate(output: str, project: str | None, project_path: str | None, views: str | None, tags_: str | None, modules_: str | None, prune_to_views: bool, exporter: str, tagging: str | None, view_generator: str | None, view_generator_config: str | None, enable_cache: bool, verbose: bool) -> None:
    ...
    try:
        ...
        dsl = build_workspace(project=project,
                              project_path=pp,
